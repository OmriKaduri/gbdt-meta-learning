...
def inner_cv_hyperopt(X, y, n_splits=3):
    ...
    # for index, (tr_ind, test_ind) in enumerate(kf):
        ...
        const_params = {
            'seed': 1,
            # 'verbose': 0,
            # 'histogram_type': 'Random' # For Extremely Randomized Trees remove this comment
        }
...
RESULTS_FILENAME = "H2O_DRF_results.csv"
...
for cls_dataset in glob.glob('classification_datasets/*.csv')[6:]:
    ...
    record = {'Dataset': dataset_name, 'Algorithm': 'H2O-DRF'}
